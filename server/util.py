...
def load_saved_artifacts():
    ...
    with open("./artifacts/class_dictionary.json", "r") as f:
        ...
        __class_number_to_name = {number:name for name, number in __class_name_to_number.items()}
...
if __name__ == '__main__':
    ...
    # print(classify_image(get_b_64_image_of_virat()))
